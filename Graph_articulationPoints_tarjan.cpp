//
// Created by Akshansh Gusain on 05/05/21.
//
//A node is an articulation point removing which the number of connected components increases.
//Application: Find single point of failure in a network.
