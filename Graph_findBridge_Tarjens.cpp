...
//
//A bridge is an edge, removing which increases the no. components
//Bridges in a network can represent critical wires or connections and is similar to single point of failure.
